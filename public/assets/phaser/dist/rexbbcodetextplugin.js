(function (global, factory) {
      ...
      value: function updatePenManager(text, wrapMode, wrapWidth, lineHeight, penManager) {
        ...
        for (var i = 0, len = match.length; i < len; i++) {
          ...
          if (curProp.img) {
            ...
            var imgHeight = this.imageManager.getOuterHeight(curProp.img);
            current_image = curProp.img;
            current_image_height = imgHeight;
            ...
            for (var j = 0, jLen = wrapLines.length; j < jLen; j++) {
              ...
              if (n.newLineMode !== NO_NEWLINE) {
                ...
                cursorX = 0;
                if (n.text === '') {
                  if (current_image !== '') { // 'division_line'
                    cursorY += current_image_height;
                  } else
                  {
                    cursorY += lineHeight;
                  }
  ...
  var ImageManager = /*#__PURE__*/function () {
    ...
    _createClass(ImageManager, [{
      ...
      key: "getOuterHeight",
      value: function getOuterHeight(key) {
        var data = this.get(key);
        console.log(data);
