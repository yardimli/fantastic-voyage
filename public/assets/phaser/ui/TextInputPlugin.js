export default class TextInput extends Phaser.Events.EventEmitter
{
    ...
    constructor (scene, font, config)
    {
        ...
        if (this.type === 'number')
        {
            ...
            console.log("______________________"+minlength);
    ...
    fakeStopInput ()
    {
        ...
        console.log('fakeStopInput '+this.id)
    ...
    fakeDownHandler (pointer)
    {
        console.log("fake click focus "+this.cursorTween+" "+this.cursorSpeed);
        this.hasFocus = false;
        this.fakeInput = true;
