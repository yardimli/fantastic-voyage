...
define('JPEG_QUALITY',          85);           // Quality of generated JPEGs (0 - 100; 100 being best)
...
if (!file_exists(THUMB_CACHE . 'index_material_kit.html')) {
    touch(THUMB_CACHE . 'index_material_kit.html');
}
if (($fp = fopen(THUMB_CACHE . 'index_material_kit.html', 'r')) !== false) {
    if (flock($fp, LOCK_EX)) {
        if (time() - THUMB_CACHE_AGE > filemtime(THUMB_CACHE . 'index_material_kit.html')) {
