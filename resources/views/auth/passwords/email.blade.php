...
<head>
	...
	<meta name="description" content="Fantastic Voyage - Unleash the Creativity Within: Where Human Ingenuity and AI Creativity Converge">
			...
			<div class="row justify-content-center text-center">
				...
				<div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
					...
					<div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
						<!-- Title -->
						<h2 class="h1 mb-2">{{__('default.Forgot Password!')}}</h2>
						<p>{{__('default.Join Now')}}<a href="{{route('register')}}" style="font-weight: bold;">{{__('default.Register')}}</a></p>
						<!-- Form START -->
						...
						<form roll="form" class="mt-4" method="POST" action="{{ route('password.email') }}">
							@csrf
							<!-- Email -->
							<div class="mb-3 position-relative input-group-lg">

								<input id="email" type="email" class="form-control @error('email') is-invalid @enderror" aria-label="Email"  name="email" value="{{ old('email') }}" placeholder="{{ __('default.Enter Email...') }}" required autocomplete="email" autofocus>
