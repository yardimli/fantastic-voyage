	...
	<div class="bg-primary pt-5 pb-0 position-relative">
		...
		<div class="container">
			<div class="row justify-content-center text-center">
				<div class="col-12">
					<!-- Title -->
					<h1 class="display-4 text-white mb-4 position-relative">{{__('default.Welcome to Fantastic Voyage!')}}</a>!
					</h1>
				...
				<div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
					...
					<div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
						<!-- Title -->
						<h2 class="h1 mb-2">Reset Password</h2>
						<!-- Form START -->
						<form roll="form" class="mt-4" method="POST" action="{{ route('password.update') }}">
							...
							<div class="mb-3 position-relative input-group-lg">
								...
								<input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
								       aria-label="Email" name="email" value="{{ old('email', $email) }}"
								       placeholder="{{ __('Enter Email...') }}" required autocomplete="email" autofocus>
							...
							<div class="mb-3">
								...
								<div class="input-group input-group-lg">
									<input type="password" class="form-control fakepassword psw-input @error('password') is-invalid @enderror"
									       ...
									       placeholder="{{ __('New Password...') }}" value="" required autocomplete="new-password">
								...
								<div class="input-group input-group-lg">
									<input type="password" class="form-control fakepassword2"
									       ...
									       placeholder="{{ __('Confirm Password...') }}" value="" required autocomplete="new-password">
									<span class="input-group-text p-0"><i
							...
							<!-- Button -->
							<div class="d-grid">
								<button type="submit" class="btn btn-lg btn-primary-soft">{{ __('Reset Password') }}</button>
							</div>
							<!-- Copyright -->
							<p class="mb-0 mt-3">©2024 <a target="_blank" href="https://www.fantastic-voyage.com/">Fantastic Voyage.</a> All
								rights
								reserved</p>
						</form>
						<!-- Form END -->
