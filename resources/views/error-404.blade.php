	...
	<nav class="navbar navbar-expand-lg">
        ...
        <!-- Nav Search END -->
              ...
              <li> <a class="dropdown-item" href="messaging.html">Messaging</a></li>
                ...
                <a class="dropdown-item dropdown-toggle" href="#!">Profile</a>
								<ul class="dropdown-menu" data-bs-popper="none">
									<li> <a class="dropdown-item" href="my-profile.blade.php">Feed</a> </li>
              ...
              <li> <a class="dropdown-item" href="create-page.html">Create a page</a></li>
							<li> <a class="dropdown-item" href="settings.blade.php">Settings</a> </li>
              ...
              <li> <a class="dropdown-item" href="../chat/offline.blade.php">Offline</a> </li>
        ...
        <li class="nav-item ms-2">
					<a class="nav-link icon-md btn btn-light p-0" href="settings.blade.php">
        ...
        <li class="nav-item ms-2 dropdown">
          ...
          <ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3" aria-labelledby="profileDropdown">
            ...
            <li class="px-3">
              ...
              <a class="dropdown-item btn btn-primary-soft btn-sm my-2 text-center" href="my-profile.blade.php">View profile</a>
            </li>
            <!-- Links -->
            <li><a class="dropdown-item" href="settings.blade.php"><i class="bi bi-gear fa-fw me-2"></i>Settings & Privacy</a></li>
            <li>
