  ...
  <div class="container">
    ...
    <div class="row align-items-center text-center py-sm-5">
      ...
      <div class="col-lg-8 mx-auto">
        ...
        <!-- SVG END -->
        <!-- 404 info -->
        <h1 class="display-1 mt-4">440</h1>
        <h2 class="mb-2 h1">Login Time-out!</h2>
        <p>Either something went wrong or you need to login again.</p>
        <!-- Button -->
        <a class="btn btn-primary-soft btn-sm" href="{{route('index')}}">Got to home page</a>
      </div>
      <!-- Error 404 START -->
    </div>
    <!-- Extra space -->
