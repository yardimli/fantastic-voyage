      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav navbar-nav-scroll me-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('index')}}">The Library</a>
            </li>
            <!-- Nav item -->
{{--            <li class="nav-item">--}}
...
{{--            </div>--}}
      ...
      <div class="row g-0 align-items-center mt-2 position-relative z-index-1">
        <div class="col-lg-4">
          ...
          <div class="iphone-x iphone-x-small" style="background: url(/assets/images/mobile_ui.png); background-size: 100%;">
            <i></i>
            <b></b>
          </div>
          <!-- iphone-x mockup END -->
            ...
            <div class="mac_scaler">
              <div class="mac_holder">
                <div class="mac_screen">
                  ...
                  <div class="mac_screen_content" style="background:url(/assets/images/desktop_ui.jpg); background-size: 100%;">
                  </div>
                </div>
          ...
          <div class="card card-body bg-mode shadow-none border-0 p-4 p-sm-5 pb-sm-0 overflow-hidden">
            <div class="row g-4">
              <div class="col-md-6">
                ...
                <p class="mb-5">Delve into the enthralling realm where human exchange with AI transcends conventional boundaries, giving birth to narratives in a melding of minds. As the dance of dialogues intertwined, each interaction shapes and molds the story, creating a symbiotic tapestry of characters and plots that fascinate and captivate the boundless potential within the ever-expanding, collaborative universe of storytelling.</p>
              </div>
              <div class="col-md-6 text-end">
                <!-- image -->
                <!-- iphone-x mockup START -->
                  <div class="iphone-x iphone-x-small iphone-x-half mb-n5 mt-0" style="background: url(/assets/images/mobile_ui.jpg); background-size: 100%;">
                    <i></i>
                    <b></b>
                  </div>
                  <!-- iphone-x mockup END -->
          ...
          <div class="row g-4 align-items-center">
              ...
              <div class="position-absolute top-50 start-0 translate-middle d-none d-lg-block">
                ...
                <div class="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                  ...
                  <div class="avatar avatar-xs me-3">
                    <a href="{{route('index')}}"> <img class="avatar-img rounded-circle" src="/assets/images/avatar/12.jpg" alt=""> </a>
                  </div>
                  <!-- Comment box  -->
                  <div class="d-flex">
                ...
                <div class="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xs me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="/assets/images/581177845_A Journey into the Limelight.jpg" alt=""> </a>
                  </div>
                  <!-- Comment box  -->
                    <div class="d-flex">
                      <h6 class="mb-0 ">Unleash Narrative Potential!</h6>
                    </div>
                  </div>
               </div>
               <!-- Chat END -->
            ...
            <div class="col-md-6">
              <div class="ms-4">
                ...
                <p class="lead mb-4">Traverse through the fabled lands wherein lays the resplendent opportunity for discovered fortune. As a weaver of tales in the grand tapestry of the mythic realm, thine own sagas shall be revealed to many an eager eye, their imaginations set alight by the enchanting flames of your prose, which finds new life within the hearts of those who seek the extraordinary.</p>
