			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none" style="min-width: 220px;">
							<li><a class="dropdown-item"
							       href="{{ route('catalogue.topics',[__('default.topics URL Link')]) }}">{{__('default.Topics')}}</a>
							</li>
							<li><a class="dropdown-item"
							       href="{{ route('catalogue.grades',[__('default.grades URL Link')]) }}">{{__('default.Grades')}}</a>
							</li>
							<li><a class="dropdown-item"
							       href="{{ route('catalogue.recommend',[__('default.recommendations URL Link')]) }}">{{__('default.Recommendations')}}</a>
							</li>
							...
							<li class="dropdown-submenu dropend">
								<a class="dropdown-item dropdown-toggle" href="#">{{__('default.Weekly Plan')}}</a>
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.weekly_plan',[__('default.weekly_plan URL Link'), __('default.Kindergarten URL Link')]) }}">{{__('default.Kindergarten')}}</a>
									</li>
									<li>
										<hr class="dropdown-divider">
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.weekly_plan',[__('default.weekly_plan URL Link'),__('default.First Grade URL Link')]) }}">{{__('default.First Grade')}}</a>
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.weekly_plan',[__('default.weekly_plan URL Link'),__('default.Second Grade URL Link')]) }}">{{__('default.Second Grade')}}</a>
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.weekly_plan',[__('default.weekly_plan URL Link'),__('default.Third Grade URL Link')]) }}">{{__('default.Third Grade')}}</a>
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.weekly_plan',[__('default.weekly_plan URL Link'),__('default.Fourth Grade URL Link')]) }}">{{__('default.Fourth Grade')}}</a>
									</li>
								</ul>
							</li>
							<li class="dropdown-submenu dropend">
								<a class="dropdown-item dropdown-toggle" href="#">{{__('default.Textbook')}}</a>
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.textbook',[__('default.textbook URL Link'), __('default.Kindergarten URL Link')]) }}">{{__('default.Kindergarten')}}</a>
									</li>
									<li>
										<hr class="dropdown-divider">
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.textbook',[__('default.textbook URL Link'),__('default.First Grade URL Link')]) }}">{{__('default.First Grade')}}</a>
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.textbook',[__('default.textbook URL Link'),__('default.Second Grade URL Link')]) }}">{{__('default.Second Grade')}}</a>
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.textbook',[__('default.textbook URL Link'),__('default.Third Grade URL Link')]) }}">{{__('default.Third Grade')}}</a>
									</li>
									<li><a class="dropdown-item"
									       href="{{ route('catalogue.textbook',[__('default.textbook URL Link'),__('default.Fourth Grade URL Link')]) }}">{{__('default.Fourth Grade')}}</a>
									</li>
								</ul>
							</li>
...
{{--						</ul>--}}
					...
					<!-- Link block -->
					<div class="col-6 col-md-4">
{{--						<h5 class="mb-2 mb-md-4">{{__('default.Teaching')}}</h5>--}}
{{--						<ul class="nav flex-column">--}}
{{--							<li class="nav-item"><a class="nav-link"--}}
{{--							                        href="{{ route('template.show.home') }}">{{__('default.How to guide')}}</a>--}}
{{--							</li>--}}
{{--							<li class="nav-item"><a class="nav-link"--}}
{{--							                        href="{{ route('template.show.home') }}">{{__('default.Terms & Conditions')}}</a>--}}
{{--							</li>--}}
{{--						</ul>--}}
					</div>
				</div>
...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link
	href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500&family=Roboto&family=Rubik:wght@300;400;500&display=swap"
	rel="stylesheet">
