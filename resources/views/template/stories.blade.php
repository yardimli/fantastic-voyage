...
@section('content')
	...
	<main class="pt-5">
		...
		<!-- Page header START -->
		<div class="py-5"
		     style="background-image:url(/assets/images/header/pexels-tobias-bjørkli-1853354_cr.jpg); background-position: center center; background-size: cover; background-repeat: no-repeat;">
			<div class="container">
				
				<div class="row justify-content-center py-5">
					<div class="col-md-6 text-center">
						<!-- Title -->
						<h1 class="text-white" style="background-color: rgba(0,0,0,0.5)">Welcome to FICTION•<span>FUSION</span></h1>
						<span class="mb-4 text-white" style="background-color: rgba(0,0,0,0.5)">Bridging the Divide – Human Imagination Meets AI Innovation!</span>
					</div>
				</div>
			</div>
		</div>
