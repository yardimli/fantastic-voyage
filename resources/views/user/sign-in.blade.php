						...
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<div class="row">
								...
								<div class="col-xxl-6 d-grid">
									<a href="{{ route('index') }}" class="btn bg-google mb-2 mb-xxl-0"><i class="fab fa-fw fa-google text-white me-2"></i>Login with Google</a>
								</div>
								<!-- Social btn -->
								<div class="col-xxl-6 d-grid">
									<a href="{{ route('index') }}" class="btn bg-facebook mb-0"><i class="fab fa-fw fa-facebook-f me-2"></i>Login with Facebook</a>
								</div>
							</div>
