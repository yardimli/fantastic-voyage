			...
			<div class="row">
				...
				<div class="col-12 col-lg-6 d-md-flex align-items-center justify-content-center bg-primary bg-opacity-10 vh-lg-100">
					<div class="p-3 p-lg-5">
						...
						<!-- SVG Image -->
						<img src="/assets/images/element/login_side_image.png" class="mt-5" alt="">
						<!-- Info -->
						...
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<form>
								...
								<div class="mb-4">
									<div class="form-check">
										...
										<label class="form-check-label" for="checkbox-1">By signing up, you agree to the<a href="{{ route('index') }}"> terms of service</a></label>
									</div>
								</div>
								<!-- Button -->
							...
							<div class="row">
								...
								<div class="col-xxl-6 d-grid">
									<a href="{{ route('index') }}" class="btn bg-google mb-2 mb-xxl-0"><i class="fab fa-fw fa-google text-white me-2"></i>Signup with Google</a>
								</div>
								<!-- Social btn -->
								<div class="col-xxl-6 d-grid">
									<a href="{{ route('index') }}" class="btn bg-facebook mb-0"><i class="fab fa-fw fa-facebook-f me-2"></i>Signup with Facebook</a>
								</div>
							</div>
